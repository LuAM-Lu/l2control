...
- [~] **F1-21 · Frontend adaptable e instalable** — **alcance añadido el 2026-09-16 a petición del
  ...
  por olas en orquesta; la auditoría de partida está en [AUDITORIA-FRONTEND.md](cerrados/AUDITORIA-FRONTEND.md).
...
| **DEC-23** OK | A quien se factura | **Consumidor final por defecto; cedula o RIF y nombre cuando el cliente lo pide** (D14 de [UX-MEJORAS.md](cerrados/UX-MEJORAS.md)) | En una caja con cola nadie teclea una cedula para un jugo. Contrato `ClienteFacturaSchema`: una factura identificada sin documento no se puede expresar. La direccion fiscal es opcional hasta que el contador confirme los requisitos (DEC-1) |
